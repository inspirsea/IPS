...
var Context = /** @class */ (function () {
    ...
    Context.prototype.initShaders = function (options) {
        ...
        this.getDefaultImage().subscribe(function (it) {
            ...
            _this.loadImages(options.textures).subscribe(function (imageItems) {
                _this.initTextures(_this.gl, imageItems);
                _this.loaded.next();
            });
        });
    };
    Context.prototype.loadImages = function (imageItems) {
        var imgLoaders = [];
        var _loop_1 = function (item) {
            var loader = rxjs_1.Observable.create(function (obs) {
                if (typeof item.image == "string") {
                    var img_1 = document.createElement("img");
                    img_1.crossOrigin = "Anonymous";
                    img_1.src = item.image;
        ...
        return rxjs_1.Observable.forkJoin(imgLoaders);
    };
    Context.prototype.initTextures = function (gl, imageItems) {
        for (var _i = 0, imageItems_2 = imageItems; _i < imageItems_2.length; _i++) {
            var imageItem = imageItems_2[_i];
