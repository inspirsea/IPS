...
var ParticleEmitter = /** @class */ (function () {
    ...
    Object.defineProperty(ParticleEmitter.prototype, "startOption", {
        ...
        set: function (value) {
            if (this.positionType == ips_positiontype_1.IpsPositiontype.Pixel) {
                ...
                this._startOption.y.min = util_1.Util.pixelToRelative(value.y.min, this.height);
                this._startOption.y.max = util_1.Util.pixelToRelative(value.y.max, this.height);
            }
            else {
    ...
    ParticleEmitter.prototype.setStartOption = function (value) {
        this.startOption = value;
    };
    ParticleEmitter.prototype.setBlendmodeSource = function (value) {
        this.blendmodeSource = value;
    };
    ParticleEmitter.prototype.setBlendmodeTarget = function (value) {
        this.blendmodeTarget = value;
    };
    ParticleEmitter.prototype.setTextureKey = function (value) {
        this.textureKey = value;
    };
    ParticleEmitter.prototype.setSizeOption = function (value) {
        this.sizeOption = value;
    };
    ParticleEmitter.prototype.setVelocityOption = function (value) {
    ...
    ParticleEmitter.prototype.setGrowth = function (value) {
